<div class="reviews-se py-90 bg-2">
    <div class="container-fluid">
      <!-- se-title -->
      <div class="se-title">
        <h3 class="sub-title">Flyhost Reviews</h3>
      ...
      <div class="reviews-slider" id="reviews-slider" dir="ltr">
        ...
        <div class="t-box">
          ...
          <!-- text -->
          <p class="text hdkasdh mb-3">Flyhost is truly an efficient service. I moved my two domains over to Flyhost to enhance security of my websites, and Flyhost has kept its promise to protect my domains. When I call, the representatives are friendly and knowledgable. I am a happy client.</p>
          <!-- c-info -->
          <div class="c-info d-flex align-items-center mt-auto">
            <!-- avatar -->
            <div class="avatar mr-1">
              <img src="assets/images/avatars/01.png" class="img-fluid" alt="Customer">
            </div>
            <!-- c-text -->
            <div class="c-text">
        ...
        <div class="t-box">
          ...
          <!-- text -->
          <p class="text hdkasdh mb-3">I have been a Flyhost customer for years! Whenever I have needed customer service, I have had the best experience and always learn something new. Flyhost is a one-stop shop for all my domain, email, website, tech service needs. 24/7 great support! Thank you Flyhost!</p>
          <!-- c-info -->
          <div class="c-info d-flex align-items-center mt-auto">
            <!-- avatar -->
            <div class="avatar mr-1">
              <img src="assets/images/avatars/02.png" class="img-fluid" alt="Customer">
            </div>
            <!-- c-text -->
            <div class="c-text">
        ...
        <div class="t-box">
          ...
          <!-- text -->
          <p class="text hdkasdh mb-3">Flyhost has all the resources in one place to make running as a small business easy. I have my domain and website set up though them, my business phone, and my business email. All of these things build credibility with my clients. The process to set these things was very easy and seamless.</p>
          <!-- c-info -->
          <div class="c-info d-flex align-items-center mt-auto">
            <!-- avatar -->
            <div class="avatar mr-1">
              <img src="assets/images/avatars/03.png" class="img-fluid" alt="Customer">
            </div>
            <!-- c-text -->
            <div class="c-text">
      ...
      <div class="row align-items-center mt-3">
        ...
        <div class="col-lg-8 order-lg-1 order-2">
          ...
          <div class="rating-box d-md-flex align-items-center justify-content-lg-start justify-content-center text-md-left text-center">
            ...
            <!-- logo -->
            <img src="assets/images/icons/tb-logo.svg" class="logo img-fluid" alt="Trustpilot">
          </div>
        </div>
        <!-- col -->
        <div class="col-lg-4 order-lg-2 order-1 text-lg-right text-center mb-lg-0 mb-2">
          ...
          <div class="reviews-slider-arrows">
            <button type="button" class="slider-arrow" id="reviews-slider-prevArrow"><img src="assets/images/icons/prev-button.png" class="img-fluid" alt="Prev"></button>
            <button type="button" class="slider-arrow" id="reviews-slider-nextArrow"><img src="assets/images/icons/next-button.png" class="img-fluid" alt="Next"></button>
          </div>
        </div>
      </div>
    </div>
