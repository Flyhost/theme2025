<!-- :: FAQs :: -->
<?php include 'whmcs-modal.inc.php'; ?>
      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-6 mb-xl-0 mb-2">
          ...
          <div class="box d-flex align-items-center position-relative">
            ...
            <div class="icon d-flex align-items-center justify-content-center mr-2">
              <img src="assets/images/icons/big-paper-bag.png" class="img-fluid" alt="Paper Bag">
            </div>
            <!-- box-text -->
            <div class="box-text">
              <!-- box-title -->
        ...
        <div class="col-xl-4 col-lg-6 mb-lg-0 mb-2">
          ...
          <div class="box d-flex align-items-center position-relative">
            ...
            <!-- icon -->
            <div class="icon d-flex align-items-center justify-content-center mr-2">
              <img src="assets/images/icons/user.png" class="img-fluid" alt="User">
            </div>
            <!-- box-text -->
            <div class="box-text">
              <!-- box-title -->
        ...
        <div class="col-xl-4 col-lg-6 ">
          ...
          <div class="box d-flex align-items-center position-relative">
            ...
            <!-- icon -->
            <div class="icon d-flex align-items-center justify-content-center mr-2">
              <img src="assets/images/icons/speech-bubble.png" class="img-fluid" alt="Speech Bubble">
            </div>
            <!-- box-text -->
            <div class="box-text">
              <!-- box-title -->
    ...
    <div class="footer-bottom">
      ...
      <div class="content d-flex align-items-start mb-2">
        ...
        <ul class="social-list list-unstyled d-flex align-items-center justify-content-lg-end justify-content-center ml-lg-auto mt-lg-0 mt-2">
          <li><a href="#"><img src="assets/images/icons/social/twitter.png" alt="Icon"></a></li>
          <li><a href="#"><img src="assets/images/icons/social/reddit.png" alt="Icon"></a></li>
          <li><a href="#"><img src="assets/images/icons/social/facebook-d.png" alt="Icon"></a></li>
          <li><a href="#"><img src="assets/images/icons/social/linkedin.png" alt="Icon"></a></li>
        </ul>
      </div>
      <!-- content -->
