...
<head>
  ...
  <meta name="description" content="Sign up for a Flyhost account and unlock a world of reliable web hosting services. Join thousands of satisfied customers and experience top-notch performance and support.">
  <meta name="keywords" content="create account, sign up, web hosting services, reliable hosting, Flyhost">
  <meta name="language" content="en">
  <!-- :: Title :: -->
  <title>Create an Account - Flyhost Web Hosting Services</title>
  <!-- :: Favicon :: -->
      ...
      <div class="col-lg-6 left-col d-flex align-items-center justify-content-center">
        ...
        <div class="form-container">
          ...
          <div class="form-head">
            <!-- form-title -->
            <h2 class="form-title">
              <img src="./assets/images/icons/waving-hand-emoji.png" class="img-fluid" alt="Icon">
              Welcome in<br>Flyhost Website
            </h2>
          </div>
          <!-- login-form -->
          <form action="#" class="login-form">
            <!-- f-label -->
            <label class="f-label" for="fName">
              <!-- f-input -->
              <input class="f-input" type="text" name="fName" id="fName" placeholder="Full Name" required>
              <!-- state -->
          ...
          <!-- comment -->
          <p class="comment text-center mt-3">Have an account? <a href="login.php">Sign in</a></p>
        </div>
      </div>
      <!-- col -->
      <div class="col-lg-6 right-col d-flex align-items-center justify-content-center">
        <!-- rc-img -->
        <img src="./assets/images/elements/cloud-storage.png" class="rc-img img-fluid d-lg-block d-none" alt="Image">
        <!-- text -->
        <div class="text">
          <!-- links -->
